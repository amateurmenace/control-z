...
11. **Documents in the record.** PDF ingestion (warrants, comprehensive plans, budgets, filings): chunk, embed, link to issues, interleave on timelines with page-level citations.
12. **Vote Ledger.** Structured motions/votes extraction → per-issue and per-member roll-call grids, filterable, every cell linking to the video moment.
