...
const CACHE = 'cz-record-1.9.0-d676ae244e9cf3be';
const SHELL = ["/app/","/app/app.css?v=1.9.0","/app/app.js?v=1.9.0","/app/favicon.svg","/app/manifest.json","/app/stats.json","/app/s","/app/watching","/app/officials"];
